...
temperature_series = hourly_df['T (degC)'].dropna()

# Scale data to [0, 1]
scaler = MinMaxScaler(feature_range=(0,1))
values = temperature_series.values.reshape(-1, 1)
...
torch.save(model.state_dict(), 'saved-models/model_temp.pth')
with open('saved-models/scaler_temp.pkl', 'wb') as f:
    pickle.dump(scaler, f)

print("Saved model to 'saved-models/model_temp.pth' and scaler to 'saved-models/scaler_temp.pkl'.")
